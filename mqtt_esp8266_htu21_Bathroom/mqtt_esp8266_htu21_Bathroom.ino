...
const char* clientID = "Simple_esp01_htu21_Bathroom";      // 用戶端ID，隨意設定。
const char* topic = "bathroom";
...
void loop() {
 ...
 /* DEMO - 1 */
  ...
  Serial.print(F("Temperature.........: ")); Serial.print(myHTU21D.readTemperature() ); Serial.println(F(" +-0.3C"));
    ...
    client.publish("temp/bathroom", msg);       // 發布MQTT主題與訊息
        Serial.print(F("MQTT>> temp/bathroom ; "));Serial.println(msg);
    msgStr = "";
    delay(100);
    ...
    client.publish("hum/bathroom", msg); 
        Serial.print(F("MQTT>> hum/bathroom ; "));Serial.println(msg);
    msgStr = "";
